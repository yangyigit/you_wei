<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:39:"./template/pc/lists_single_wangzhan.htm";i:1654563692;s:52:"/Users/hengji/开发/yangyidemo/template/pc/head.htm";i:1686991424;s:52:"/Users/hengji/开发/yangyidemo/template/pc/down.htm";i:1654564114;s:54:"/Users/hengji/开发/yangyidemo/template/pc/footer.htm";i:1654564300;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="wp">
      <div class="s cl">
        ...
        <div class="data"> <a href="javascript:">
          ...
          <div class="m"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/hy.png" width="45" height="45" /></div>
        ...
        <div class="data"> <a href="javascript:">
          ...
          <div class="m"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/bbs.png" width="45" height="45" /></div>
          <p class="des">会员管理及分级权限、板块分级及权限、帖子管理</p>
          </a> </div>
        <div class="data"> <a href="javascript:">
          <div class="title">政府官网</div>
          <div class="m"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/gov.png" width="45" height="45" /></div>
          <p class="des">政府机构信息化建设，便民服务窗口，安全稳定</p>
          </a> </div>
        <div class="data"> <a href="javascript:">
          <div class="title">活动官网</div>
          <div class="m"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/action.png" width="45" height="45" /></div>
          <p class="des">活动官方网站，信息发布、投票、报名、评比等</p>
          </a> </div>
        <div class="data"> <a href="javascript:">
          <div class="title">O2O系统</div>
          <div class="m"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/o2o.png" width="45" height="45" /></div>
          <p class="des">商家入驻、LBS定位、商品、附近商家、购物车、会员管理</p>
          </a> </div>
        <div class="data"> <a href="javascript:">
          <div class="title">外贸网站</div>
          <div class="m"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/global.png" width="45" height="45" /></div>
