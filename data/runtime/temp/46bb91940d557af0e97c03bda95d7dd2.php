<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:34:"./template/pc/lists_single_app.htm";i:1654563566;s:52:"/Users/hengji/开发/yangyidemo/template/pc/head.htm";i:1686991424;s:52:"/Users/hengji/开发/yangyidemo/template/pc/down.htm";i:1654564114;s:54:"/Users/hengji/开发/yangyidemo/template/pc/footer.htm";i:1654564300;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="wp">
      <div class="s cl">
        <div class="data"> <a href="javascript:">
          ...
          <p class="des">可以在手机浏览器、微信、独立APP等各种环境浏览的网站</p>
          </a> </div>
        <div class="data"> <a href="javascript:">
          <div class="title">APP开发</div>
          <div class="m"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/ios.png" width="45" height="45"></div>
          <p class="des">IOS和安卓两大主流平台的移动APP客户端开发</p>
          </a> </div>
        <div class="data"> <a href="javascript:">
          <div class="title">API开发</div>
          ...
          <p class="des">APP及网站服务端开发，提供规范的API技术文档</p>
          </a> </div>
        <div class="data"> <a href="javascript:">
          <div class="title">H5单页</div>
          <div class="m"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/h5.png" width="45" height="45"></div>
          <p class="des">提供活动、报名、招聘等形式的H5高逼格单页开发</p>
          </a> </div>
      </div>
    </div>
  </div>
