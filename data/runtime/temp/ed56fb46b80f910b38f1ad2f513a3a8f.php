<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:23:"./template/pc/index.htm";i:1687059397;s:52:"/Users/hengji/开发/yangyidemo/template/pc/head.htm";i:1686991424;s:54:"/Users/hengji/开发/yangyidemo/template/pc/footer.htm";i:1687059629;}*/ ?>
<!DOCTYPE html>
...
<div class="main">
            ...
            <div class="s wps cl">
                ...
                <div class="sub">
                    <dl>
                        ...
                        <dd class="m"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/pc1.png" width="80"
                                           height="80" alt="<?php echo $field['typename']; ?>"/></dd>
                    ...
                    <ul class="on">
                        <div class="ul-s">
                            ...
                            <div class="index2n"><a href="<?php echo $field['typeurl']; ?>" class="btn-a"><em></em><span>查看详情</span></a>
                            </div>
                        </div>
                    </ul>
                </div>
                ...
                <div class="sub">
                    <dl>
                        <dt><?php echo $field['typename']; ?></dt>
                        <dd class="m"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/pc2.png" width="80"
                                           height="80" alt="<?php echo $field['typename']; ?>"/></dd>
                        <dd class="des"><?php echo $field['seo_description']; ?></dd>
                    </dl>
                    </dl>
                ...
                <div class="sub">
                    <dl>
                        <dt><?php echo $field['typename']; ?></dt>
                        <dd class="m"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/pc3.png" width="80"
                                           height="80" alt="<?php echo $field['typename']; ?>"/></dd>
                        <dd class="des"><?php echo $field['seo_description']; ?></dd>
                    </dl>
                    </dl>
                ...
                <div class="sub">
                    <dl>
                        <dt><?php echo $field['typename']; ?></dt>
                        <dd class="m"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/pc4.png" width="80"
                                           height="80" alt="<?php echo $field['typename']; ?>"/></dd>
                        <dd class="des"><?php echo $field['seo_description']; ?></dd>
                    </dl>
                    </dl>
    ...
    <div class="index-case">
        <div class="index-case-title-box">
            <div style="box-sizing: border-box;">
                <a class="index-case-title-a" onclick="changeContent(this,1)">
                    <span class="index-case-title-icon"></span>
                    <span class="index-case-title">电力行业系统解决方案</span>
                </a>
                <a class="index-case-title-a" onclick="changeContent(this,2)">
                    <span class="index-case-title-icon"></span>
                    <span class="index-case-title">终端电气系统解决方案</span>
                </a>
                <a class="index-case-title-a" onclick="changeContent(this,3)">
                    <span class="index-case-title-icon"></span>
                    <span class="index-case-title">终端电气系统解决方案</span>
                </a>
            </div>
        ...
        <div class="index-case-content-box">
            <div class="index-case-content-bg bg-1">
                <div class="index-case-content">
                    <div class="index-case-content-title">电力行业系统解决方案</div>
                    <p class="index-case-content-desc">专业服务于三峡工程、越南太安水电站、四川乐英水电站等电力企业...</p>
                    <a class="index-case-content-btn" href="javascript:void(0)">行业案例<span>➜</span></a>
                </div>
            </div>

            <div class="index-case-content-bg  bg-2">
                <div class="index-case-content">
                    <div class="index-case-content-title">终端电气系统解决方案</div>
                    <p class="index-case-content-desc">专业服务于浦东机场、北京地铁、奥运场馆等国家重大工程...</p>
                    <a class="index-case-content-btn" href="javascript:void(0)">行业案例<span>➜</span></a>
                </div>
            </div>

            <div class="index-case-content-bg bg-3">
                <div class="index-case-content">
                    <div class="index-case-content-title">终端电气系统解决方案</div>
                    <p class="index-case-content-desc">专业服务于南水北调、青藏铁路、嫦娥探月工程等..</p>
                    <a class="index-case-content-btn" href="javascript:void(0)">行业案例<span>➜</span></a>
                </div>
            </div>
  ...
  'orderby' => 'add_time',
    ...
    <div class="index-news"> <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "11"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagType = new \think\template\taglib\eyou\TagType; $_result = $tagType->getType($typeid, "self", ""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: $field = $__LIST__;?>
        ...
        <div class="s wp cl"> <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "11"; endif; if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 3; endif; $tagChannelartlist = new \think\template\taglib\eyou\TagChannelartlist; $_result = $tagChannelartlist->getChannelartlist($typeid, "son",""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1;$__LIST__ = is_array($_result) ? array_slice($_result,0, $row, true) : $_result->slice(0, $row, true); if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$channelartlist): $channelartlist["typename"] = text_msubstr($channelartlist["typename"], 0, 100, false); $__LIST__[$key] = $_result[$key] = $channelartlist;$i= intval($key) + 1;$mod = ($i % 2 ); ?>
            <div class="news-list">
                <div class="list-s">
                    <div class="m"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/index-list<?php echo $i; ?>.jpg"
                                        width="368" height="120" alt="<?php  $__VALUE__ = isset($channelartlist["typename"]) ? $channelartlist["typename"] : "变量名不存在"; echo $__VALUE__; ?>"/>
  ...
  'orderby' => 'add_time',
                        ...
                        <li class="cl">
                            <div class="m"><img src="<?php echo $field['litpic']; ?>" width="130" height="130" alt="<?php echo $field['title']; ?>"/>
                            </div>
...
<!--    </div>-->
    <div class="index-contact">
        <div class=" wp">
            <div class="s">
                ...
                <p>有为物联努力让每一次邂逅总能超越期待</p>
                <div class="btn"><a
                        href="https://wpa.qq.com/msgrd?v=3&uin=<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_5"); echo $__VALUE__; ?>&site=qq&menu=yes"
                        target="_blank" class="btn-a"><em></em><span>立即联系</span></a></div>
            </div>
        </div>
        <div class="cover"></div>
    </div>
    ...
    <script>
        ...
        function changeContent(obj,tag){
            $(obj).children('.index-case-title-icon').css({"background":"#315ffd","width":"22px"})
            $(obj).siblings().children('.index-case-title-icon').css({"background":"#ffffff","width":"12px"})
            $(obj).children('.index-case-title').css({"color":"#315ffd","margin-left":"30px"})
            $(obj).siblings().children('.index-case-title').css({"color":"#ffffff","margin-left":"40px"})
            $('.bg-'+tag).css({"z-index":"2","opacity":"1"})
            $('.bg-'+tag).siblings().css({"z-index":"1","opacity":"0"});
        }
    </script>
</div>
<div class="footer">
